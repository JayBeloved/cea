      ...
      <div className="container mx-auto px-4">
        ...
        {posts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post: any) => (
              <Link key={post.id} href={`/blog/${post.slug}`} className="group flex flex-col h-full border rounded-xl overflow-hidden bg-card hover:shadow-lg transition-all duration-300">
